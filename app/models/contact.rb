class Contact < ApplicationRecord
  ...
  has_many :correspondences_from, -> { where from_type: "Contact" }, class_name: Correspondence,
                                                                     foreign_key: :from_id,
                                                                     foreign_type: :from_type
  has_many :correspondences_to, -> { where to_type: "Contact" }, class_name: Correspondence,
                                                                 foreign_key: :to_id,
